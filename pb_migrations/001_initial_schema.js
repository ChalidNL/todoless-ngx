    ...
    createCollection(
      new Collection({
        ...
        fields: [
          ...
          { name: 'sprint_id', type: 'relation', collectionId: 'sprints', cascadeDelete: false, maxSelect: 1 },
    ...
    createCollection(
      new Collection({
        ...
        fields: [
          ...
          { name: 'shop_id', type: 'relation', collectionId: 'shops', cascadeDelete: false, maxSelect: 1 },
    ...
    createCollection(
      new Collection({
        ...
        fields: [
          ...
          { name: 'used', type: 'bool' },
          { name: 'used_by', type: 'relation', collectionId: '_pb_users_auth_', cascadeDelete: false, maxSelect: 1 },
